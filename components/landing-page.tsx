        ...
        <div className="w-full h-full bg-[url('/texture.svg')]">
            <div className="h-full w-full flex justify-center overflow-hidden pl-20 items-center bg-gradient-to-b from-white via-transparent via-40% to-white">
                <div className="flex flex-col gap-3">
                    ...
                    <a href="#" className='w-1/6 h-10 flex items-center justify-center font-sans tracking-tight font-medium text-xl bg-nupurple rounded-lg text-white hover:scale-105 duration-200'>Sign Up</a>
                </div>
