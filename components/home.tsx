        ...
        <div className="w-full h-full" id="home">
            <div className="h-full w-full flex justify-center overflow-hidden pl-4 lg:pl-20 items-center bg-gradient-to-b from-white via-transparent via-40% to-white">
                <div className="flex flex-col gap-2 lg:gap-3">
                    <p className='h-[47px] lg:h-24 -ml-[2px] lg:-ml-1 -mb-2 lg:-mb-3 text-[36px] lg:text-8xl tracking-tight font-sans font-bold animate-[loadOne_2.25s_ease] text-transparent bg-clip-text bg-gradient-to-b from-nupurple via-nupurple via-65%' id="home-title">Northwestern AI</p>
                    <p className="w-11/12 lg:w-2/3 text-sm leading-tight lg:leading-normal lg:text-2xl font-sans font-normal tracking-tight animate-[loadTwo_2.25s_ease] text-nulight">Educating and Empowering Students to Shape the Future with Artificial Intelligence.</p>
