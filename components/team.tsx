        ...
        return (
            <div className="w-full h-screen flex flex-col items-center justify-center gap-10" id="team">
                ...
                <div className="flex flex-row gap-10 lg:gap-20">
                    <div className="flex flex-col items-center">
                        <a href="https://www.linkedin.com/in/gracedowning2024/" className="hover:scale-105 duration-200" target="_blank">
                            <Image src="/grace.jpeg" width={1000} height={1000} alt='' className='w-36 h-36 lg:h-48 lg:w-48 object-cover rounded-full border-[3px] lg:border-4 border-gray-400'/>
                        </a>
                    ...
                    <div className="flex flex-col items-center">
                        <a href="https://www.linkedin.com/in/helena-guajardo-298880226/" className="hover:scale-105 duration-200" target="_blank">
                            <Image src="/helena.jpeg" width={1000} height={1000} alt='' className='w-36 h-36 lg:h-48 lg:w-48 object-cover rounded-full border-[3px] lg:border-4 border-gray-400'/>
                        </a>
                    ...
                    <div className="flex flex-col items-center">
                        <a href="https://www.linkedin.com/in/varoonenjeti/" className="hover:scale-105 duration-200" target="_blank">
                            <Image src="/varoon.png" width={1000} height={1000} alt='' className='w-36 h-36 lg:h-48 lg:w-48 object-cover rounded-full border-[3px] lg:border-4 border-gray-400'/>
                        </a>
