...
export default function Team() {
	...
	if (width < breakpoint) {
		return (
			<div
				className="mt-20 lg:mt-0 w-full h-screen flex flex-col items-center justify-center gap-5"
				id="team"
			>
				<p className="font-sans font-bold text-3xl text-nupurple tracking-tight mt-12">
					Meet the Team!
				</p>
				<div className="flex flex-col items-center">
					...
					>
						<Image
							...
							height={1000}
							alt=""
							className="h-36 w-36 object-cover rounded-full border-2 border-gray-400"
						/>
					</a>
					<p className="font-sans font-medium text-md tracking-tight mt-1">
						Varoon Enjeti
					</p>
					<p className="font-sans font-light text-md tracking-tight">
						President
					</p>
				</div>
				<div className="w-full h-56 flex items-center justify-center gap-10 -mt-5">
					<div className="flex flex-col items-center">
						<a
							href="https://www.linkedin.com/in/james-carlin-12508519b/"
							className="hover:scale-105 duration-200"
							target="_blank"
						>
							<Image
					...
					{/* <div className="flex flex-col items-center">
						<a
							href="https://www.linkedin.com/in/gracedowning2024/"
							className="hover:scale-105 duration-200"
							target="_blank"
						>
							<Image
				...
				<div className="w-full h-56 flex items-center justify-center gap-10 -mt-5">
					<div className="flex flex-col items-center">
						<a
							href="https://www.linkedin.com/in/jonahcoleberman/"
							className="hover:scale-105 duration-200"
							target="_blank"
						>
							<Image
		...
		return (
			<div
				...
				id="team"
			>
				<p className="font-sans font-bold text-3xl lg:text-5xl text-nupurple tracking-tight mt-12">
					Meet the Team!
				</p>
					...
					<div className="flex flex-col items-center">
						...
						>
							<Image
								...
								height={1000}
								alt=""
								className="w-36 h-36 lg:h-48 lg:w-48 object-cover rounded-full border-[3px] lg:border-4 border-gray-400"
							/>
						</a>
