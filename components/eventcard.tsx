...
export default function Eventcard(props:Card) {
    return (
        <div className="h-[164px] lg:h-64 2xl:h-76 w-11/12 lg:w-1/3 bg-gray-300 rounded-2xl flex flex-col lg:gap-1 px-3 py-2 lg:px-5 lg:py-4 font-sans tracking-tight shadow-xl hover:scale-105 duration-200">
